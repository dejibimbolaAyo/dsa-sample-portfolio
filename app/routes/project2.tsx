...
export const meta: MetaFunction = () => [{ title: "Project 2 - Portfolio" }];
      ...
      <div className="max-w-4xl mx-auto py-24 px-4">
        ...
        <div className="mt-8 flex flex-col md:flex-row gap-10 items-center">
          <div className="flex-1">
            <h1 className="text-4xl font-extrabold mb-4">Project 2 Title</h1>
            <p className="text-zinc-400 mb-6">
              A detailed description of Project 2, its goals, features, and what
